    ...
    return (
        <div className='header_wrapper_main'>
            <div className='header_wrapper'>
                <div className='header_wrapper_first_div'>
                    <div className='header_abstract'>
                        <svg class="abstract-logo logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 51" preserveAspectRatio="xMinYMid slice">
                    ...
                    <div className='header_wrapper_first_div_line'></div>
                    <p className='header_help'>Help Center</p>
                </div>

                <div className='header_wrapper_second_div'>
                    <button className='header_wrapper_second_div_first_btn'>Submit a request</button>
                    <button className='header_wrapper_second_div_second_btn'>Sign in</button>
                </div>
            </div>
        </div>
